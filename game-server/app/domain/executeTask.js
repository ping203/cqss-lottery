 ...
 * @api public
 */
ExecuteTask.prototype.updateTaskData = function(player, killed) {
  if (player.type === consts.EntityType.MOB) {return;}
	...
	if (!!reData) {
	  this.messageService.pushMessageToPlayer({uid:player.userId, sid : player.serverId}, 'onUpdateTaskData', reData);
	}
};
...
module.exports ={
	...
	func:ExecuteTask,
	props:[
		{name:"messageService",ref:"messageService"},
